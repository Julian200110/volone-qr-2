    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="text-white max-w-full w-[90%] h-full relative">
            <motion.p
            ...
            >
              ...
              <p className="ml-[38px]">{post.title}</p>
              <div className="absolute flex flex-col z-30 justify-center ml-[280px] gap-2">
                {/* PRECIO */}
                <motion.p
                  className="text-base font-mangoli text-white border border-white rounded-[14px] p-2 flex flex-col w-[97px] h-[63px] items-center justify-center bg-[#A4A4A4]/42 backdrop-blur-md  text-center shadow-[-3px_4px_3px_rgba(0,0,0,0.3)]"
                  // initial={{ x: -20, opacity: 0 }}
                  // animate={{ x: 0, opacity: 1 }}
                  // transition={{ delay: 0.3 }}
                >
            ...
            <motion.div className="flex flex-col text-base space-between font-manrope font-extralight font-extralight text-[11px]">
              <div className="flex items-start gap-2  w-[500px]">
                ...
                /> */}
                <div className="text-white font-manrope font-extralight text-[12px] w-[200px] flex flex-col ml-[38px]">
