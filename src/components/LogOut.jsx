...
const LogOut = ({ isOpen, onClose, selectedItem, children, message }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-black  rounded-[9px] p-8 shadow-lg relative max-w-[190px] w-full text-[14px] text-white border border-[#E50051] h-[89px] flex items-center justify-center text-center font-mangoli">
        {/* <button
