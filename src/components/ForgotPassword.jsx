    ...
    >
        ...
        <div className="w-[278px] mx-auto mt-[150px] flex flex-col gap-[25px] text-[12px]">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex justify-center">
              <button className="text-center bg-[#E50051] border text-[12px] h-[29px] w-[96px] rounded-full border-[#E50051]">
                Guardar
              </button>
            </div>
          </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-[60]">
          <div className="bg-[#1E1E1E] rounded-[14px] p-4 shadow-lg relative max-w-[220px] w-full">
            <div className="flex flex-col gap-3">
              <p className="text-[#E50051] font-mangoli text-[12px] mb-1">
                Código
              </p>
              <input
                type="text"
                placeholder="XXXXXXXX"
                className="w-full bg-transparent border-b border-[#E50051] text-white text-center focus:outline-none font-mangoli text-[12px] pb-1"
              />
              <div className="flex justify-center mt-2">
                <button
                  onClick={handleAcceptCode}
                  className="bg-[#E50051] text-white text-[12px] px-6 py-1 rounded-full font-mangoli"
                >
                  Aceptar
                </button>
              </div>
