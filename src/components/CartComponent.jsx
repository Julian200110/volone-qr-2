          ...
          <div className="space-y-4">
                ...
                <div className="md:flex">
                  <div className="relative">
                    <img
                      src={item.image}
                      alt={item.title}
                      className="w-full h-[129px] object-cover md:rounded-t-none group-hover:translate-x-[-15%] transition-transform duration-500"
                    />
                  ...
                  <div className="p-2  md:w-2/3">
                    ...
                    <div className="flex items-center justify-between border w-[70px] rounded-full px-2 bg-[#575757] h-[16px]">
                      <button
                        onClick={() =>
            ...
            <button
              ...
              className="flex items-center justify-center bg-[#E50051]  w-[96px] 
                                   text-white py-3 rounded-full transition-all duration-500
